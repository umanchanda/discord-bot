...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('facepalm')
        .setDescription('Generate facepalm meme image (top, bottom)')
    ...
    async execute(interaction) {
        ...
        const url = `https://api.memegen.link/images/facepalm/${topPart}/${bottomPart}.jpg?watermark=MemeComplete.com&token=mkarnglkx9jeb0uddvzt`;
